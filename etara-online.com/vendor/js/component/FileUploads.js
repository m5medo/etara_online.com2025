...
export default function() {
    store.registerHook('interceptWireModelAttachListener', (el, directive, component) => {
        ...
        let start = () => el.rawNode().dispatchEvent(new CustomEvent('livewire-upload-start', {
            bubbles: true
        }))
        let finish = () => el.rawNode().dispatchEvent(new CustomEvent('livewire-upload-finish', {
            bubbles: true
        }))
        let error = () => el.rawNode().dispatchEvent(new CustomEvent('livewire-upload-error', {
            bubbles: true
        }))
